...
<template>
  <MainLayout>
    <!-- Hero Section -->
    <section id="Hero">
    <div class="max-w-screen-2xl py-24 bg-[#F4F0F8] flex flex-col text-left px-20 text-black grid grid-cols-2">
      <div class="">
        <h3 class="mb-6 font-normal tracking-widest leading-none text-black">
          FEATURED <span class="tracking-widest leading-none">POST</span>
        </h3>
        <h1 class="mb-10 text-4xl font-bold leading-tight">
  ...
  <section  id="All Posts">
    ...
    <h1 class="col-span-3 text-black font-semibold text-5xl">All Posts</h1>
    <hr class="h-px col-span-3 my-8 border-0 bg-gray-300" />
    <div class="col-span-3 gap-8 py-6">
      <div class="flex flex-col md:flex-row bg-white overflow-hidden">
        ...
        >
          <span class="tracking-widest text-[#FFD050] font-semibold text-sm"
            >STARTUP</span
          >
          <RouterLink to="/blogpost" class="">
            <h2
              class="text-2xl md:text-3xl lg:text-4xl font-bold hover:text-[#FFD050]"
            >
    ...
    <div class="col-span-3 gap-8 py-6">
      <div class="flex flex-col md:flex-row bg-white overflow-hidden">
        ...
        <div class="w-full md:w-2/5 h-64 md:h-auto">
          <img
            class="w-full h-[318px] object-cover"
  ...
  <!-- Category Section -->
    ...
    <div class="pb-20 mx-auto max-w-screen-2xl px-20">
      <h1 class="text-left text-4xl font-bold mb-14">All Categories</h1>
      <div
      ...
      >
        <RouterLink to="/category"
          ...
          >
            <svg
              class="bg-[#FBF6EA] rounded-lg mb-4"
              width="48"
              height="48"
              viewBox="0 0 48 48"
              fill="none"
            ...
            <h1
              ...
              class="font-bold text-black group-hover:text-white mb-2"
            >
              Business
            </h1>
            <p class="mb-2 text-black group-hover:text-white">
        ...
        <a href="#">
          ...
          >
            <svg
              class="bg-[#FBF6EA] rounded-lg mb-4 justify-center items-center"
              width="48"
              height="48"
              viewBox="0 0 48 48"
              fill="none"
        ...
        <a href="#">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_533_2312)" transform="translate(12, 12)">
                <path
        ...
        <a href="#">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_533_2339)" transform="translate(12, 12)">
                <path
