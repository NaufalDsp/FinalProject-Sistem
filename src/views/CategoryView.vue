...
<template>
  <MainLayout>
    <section id="Hero">
    <div
      class="max-w-screen-2xl py-24 bg-[#F4F0F8] flex flex-col text-center justify-center items-center"
    >
      <div class="w-[515px]">
        <h1 class="text-5xl font-semibold mb-4">Business</h1>
    ...
    <div class="grid grid-cols-4">
      <div class="col-span-3 flex flex-col space-y-6">
        <div class="flex flex-row space-x-6">
          ...
          <div
            class="col-span-2 flex flex-col justify-center space-y-4 w-[512px]"
          >
            <span class="tracking-widest text-[#FFD050] font-semibold text-sm"
              >BUSINESS</span
            >
            <h2
              class="text-4xl font-bold hover:text-[#FFD050] tracking-tighter"
            >
        ...
        <a href="#">
          ...
          >
            ...
            <h1
              ...
              class="font-bold text-black group-hover:text-white"
            >
              Startup
            </h1>
          </div>
